$(document).ready(function() {
    ...
    $("#hour-09 .time-block").val(localStorage.getItem("11"));
    $("#hour-09 .time-block").val(localStorage.getItem("12"));
    $("#hour-09 .time-block").val(localStorage.getItem("13"));
    $("#hour-09 .time-block").val(localStorage.getItem("14"));
    $("#hour-09 .time-block").val(localStorage.getItem("15"));
    $("#hour-09 .time-block").val(localStorage.getItem("16"));
    $("#hour-09 .time-block").val(localStorage.getItem("17"));
});
...
e.innerHTML=t;var a=moment().format("HH");$("#clearFieldsBtn").click(function(t){t.preventDefault,
    $("textarea").val(""),
    localStorage.clear()}),
    $(".time-div").each(function()
